...
public class Constants {
	...
	public static final boolean DEBUGFiles=false;
	...
	//Timers
	public static final int timeToDisappearProgressBarLadrillos=5000;
	public static final int durationOfWarnings=1000;
	private static final int gameMode=1;
	public static Color colorBomb = new Color(153,0,0);
	
	//Game settings
	public static float probabilityOfItems = 0.05f;
